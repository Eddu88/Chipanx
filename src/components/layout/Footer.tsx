...
export function Footer({ lang, darkMode, setActivePage, onNavigate }: FooterProps) {
  ...
  return (
    <footer className={`border-t transition-theme relative z-30 ${
      darkMode 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main 3-Column Grid */}
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-12 py-16 border-b ${
          darkMode ? 'border-zinc-900' : 'border-zinc-200'
        }`}>
          
          {/* Column 1: About Brand */}
          <div className="flex flex-col gap-4">
            <h3 className={`font-display font-black text-xl tracking-[3px] uppercase ${
            ...
            <div className="flex items-center gap-3 mt-2">
              <a href="#" className={`w-9 h-9 rounded-full border flex items-center justify-center transition-all ${
                darkMode
            ...
            <ul className={`flex flex-col gap-2.5 text-sm font-medium ${
              ...
              <li>
                <button 
                  ...
                  className={`hover:text-brand-red hover:underline transition-all cursor-pointer text-left ${
            ...
            <div className="flex flex-col gap-4 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className={`text-xs mt-1 leading-normal ${
              ...
              <div className="flex items-center gap-3">
                ...
                <a 
                  href="mailto:proyectos@PRODIEM.com" 
                  className={`text-xs font-semibold hover:underline ${
                    darkMode ? 'text-zinc-300' : 'text-zinc-700'
                  }`}
                >
                  proyectos@PRODIEM.com
                </a>
              </div>
            </div>
          </div>
